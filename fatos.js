const fatosHistoricos = [
    ...
    'Hitler renúcia a sua cidadania austríaca e se torna alemão.',
    ...
    'Rosa Parks faz história ao se recusar a se levantar e dar lugar a um branco no ônibus. Sua prisão leva a um boicote à empresa e à ascensão do Pastor Martin Luther King Jr.',
    'Protestos na Hungria por democracia acabam na morte de milhares após invasão do Exército Vermelho da Comunista União Soviética.',
    'O presidente Dwight Eisenhower ordena às tropas federais que protejam 9 alunos afro-americanos que começaram a estudar no colégio Little Rock para alunos brancos, essa foi a primeira ação do governo federal contra a segregação racial no país.',
    'Os Estados Unidos lançam seu primeiro satélite, o Explorer 1.',
    'Fidel Castro invade Cuba e se consolida no poder, dando início à ditadura comunista.',
    ...
    'Ocorre a construção do muro de Berlim.',
    'A União Soviética testa mísseis em Cuba, a 145 km ao sul de Miami, dando início à resposta dos EUA sob o comando de John F. Kennedy. A resposta de Kennedy faz a União Soviética remover os mísseis de Cuba.',
    'John F. Kennedy é assassinado.',
    'O presidente Lyndon Johnson dá início à sua "Guerra à Pobreza", destacando a necessidade de reduzir a pobreza, acabar com a segregação racial e cuidar da saúde dos idosos do país. Lyndon Johnson criou ainda o ato dos direitos civis no mesmo ano.',
    ...
    'Acontece a guerra dos seis dias. Síria, Jordânia, Iraque e Egito atacam Israel, a guerra termina em 6 dias, com um cessar-fogo após Israel ocupar áreas importantes dos 4 países.',
    'Martin Luther King é assassinado.',
    'Neil Armstrong, Buzz Aldrin e Michael Collins são as primeiras pessoas a pisarem na lua.',
    'A guerra na Ásia aumenta e desperta protestos anti-guerra nos Estados Unidos devido ao envolvimento do país no continente.',
    'New York Times publica documentos sobre o envolvimento do governo americano na guerra do Vietnã.',
    'O Presidente Anticomunista Richard Nixon faz sua primeira viagem oficial à China, com o objetivo de melhorar a relação entre os dois países.',
    'A suprema corte define que os estados podem impedir o aborto a partir do terceiro trimestre de gestação, exceto quando a gestação oferece risco à vida da mulher.',
    'O presidente Richard Nixon renuncia durante o processo de impeachment causado pelo escândalo de Watergate.',
    'Dois anos depois de as últimas tropas americanas deixarem o Vietnã, as tropas comunistas capturam Saigon.',
    'Dois jatos supersônicos Concorde levantam voo simultaneamente. Um partindo de Londres para o Barein, e outro de Paris, para o Rio de Janeiro.',
    ...
    'O Irã se torna uma república islâmica.',
    'Ronald Reagan é eleito presidente dos Estados Unidos.',
    'Surge a AIDS nos Estados Unidos.',
    'O governo mexicano diz à reserva federal dos Estados Unidos que o país não consegue pagar o empréstimo de 80 bilhões de dólares.',
    'Acontece o nascimento da Internet.',
    'Desastre químico em Bophal, Índia, afeta mais de 600 mil pessoas, matando mais de 15 mil dessas.',
    ...
    'O Tenente-Coronel Oliver North e o Vice-Almirante John Pointdexter são indiciados por conspiração após venderem armas para o Irã a fim de facilitar a soltura de reféns americanos.',
    'Acontece a queda do muro de Berlim.',
    ...
    'O site Amazon.com é lançado.',
    'Ataque terrorista acontece em Oklahoma com a explosão de um caminhão-bomba.',
    'A ovelha Dolly é clonada com sucesso.',
    'A IBM Deep Blue se torna a primeira máquina a derrotar um campeão do Xadrez, derrotando Garry Kasparov duas vezes e empatando com ele três vezes em 6 partidas.',
    ...
    'A Apple anuncia seu primeiro smartphone, o iPhone.',
    ...
    '11 trabalhadores morrem e 17 ficam feridos em uma explosão na costa da Louisiana em uma exploração de óleo.',
    'Bin Laden é assassinado.',
    'Cientistas do CERN descobrem uma nova partícula através do colisor de hádrons que eles acreditam ser o Bóson de Higgs, a chamada "Partícula de Deus".',
    ...
    'Em um espaço de 4 semanas, 3 furacões atingem os Estados Unidos, Harvey, Irma e Maria atingem o Texas, Flórida e o Caribe.',
